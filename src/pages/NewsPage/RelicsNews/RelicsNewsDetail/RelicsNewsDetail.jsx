...
import './RelicsNewsDetail.scss';
import NewsItem from '../../../../components/NewsItem/NewsItem';
import Tabs from '../../../../components/Tabs/Tabs';
import Footer from '../../../../components/Footer/Footer';
SwiperCore.use([Navigation]);
export default function RelicsNewsDetail() {
    let search = window.location.pathname;
    let type = search.slice(6);
    return (
        <div className='relicsNewsDetail'>
            <div className="relicsNewsDetail__title">
                <h2 className="title">
                    Tin tức
                </h2>
            </div>
            <div className="relicsNewsDetail__tabs">
                <Tabs type={type} isDetail />
            </div>
            <div className="relicsNewsDetail__wrapper">
                <h3>
            ...
            <div className="relicsNewsDetail__relative">
                <div className="container">
                    <div className="relicsNewsDetail__relative--paginate">
                    ...
                    <div className="relicsNewsDetail__relative--slider">
                        <Swiper
                            spaceBetween={44}
                            slidesPerView={3}
                            loop={true}
                            navigation={{
                                nextEl: '.relicsNewsDetail__relative--paginate .--next',
                                prevEl: '.relicsNewsDetail__relative--paginate .--prev',
                            }}
                        >
                            <SwiperSlide>
